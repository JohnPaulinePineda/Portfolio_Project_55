...
* [**1. Table of Contents**](#TOC)
    ...
    * [1.6 Predictive Model Development](#1.6)
        ...
        * [1.6.3 Modelling Pipeline Development](#1.6.3)
            * [1.6.3.1 Cox Proportional Hazards Regression](#1.6.3.1)
            * [1.6.3.2 Cox Net Survival](#1.6.3.2)
            * [1.6.3.3 Survival Tree](#1.6.3.3)
            * [1.6.3.4 Random Survival Forest](#1.6.3.4)
            * [1.6.3.5 Gradient Boosted Survival](#1.6.3.5)    
        ...
        * [1.6.8 Gradient Boosted Survival Model Fitting | Hyperparameter Tuning | Validation](#1.6.8)
...
[Concordance Index](https://link.springer.com/book/10.1007/978-3-319-31245-3/) measures the model's ability to correctly order pairs of observations based on their predicted survival times. Values range from 0.5 to 1.0 indicating no predictive power (random guessing) and perfect predictions, respectively. As a metric, it provides a measure of discriminative ability and useful for ranking predictions. However, it does not provide information on the magnitude of errors and may be insensitive to the calibration of predicted survival probabilities.
...
![ModelDeployment2_Summary_0.png](e8f67fc9-2f00-4d92-b03a-a5af00dee72d.png)

![ModelDeployment2_Summary_1.png](e2ac153d-b8dc-4ab1-a70c-f4c19c57ef47.png)
