...
from model_prediction_community_cloud_app import compute_individual_coxph_survival_probability_class, compute_list_coxph_survival_profile, bin_numeric_model_feature, plot_kaplan_meier
from pathlib import Path

##################################
# Defining file paths
##################################
DATASETS_FINAL_PATH = Path("datasets/final/complete")
DATASETS_FINAL_TRAIN_PATH = Path("datasets/final/train")
...
DATASETS_PREPROCESSED_PATH = Path("datasets/preprocessed")
...
if entered:
    ...
    # the test case
    ##################################
    coxph_pipeline = joblib.load(PIPELINES_PATH / "coxph_pipeline.pkl")
